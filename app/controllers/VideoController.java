...
public class VideoController extends Controller {
    public static Result index() {
        if (Video.find.findRowCount() == 0) {
            ...
            Video v = new Video("Beatbox brilliance", "Blah", "http://img.youtube.com/vi/GNZBSZD16cY/0.jpg");
            v.save();
            v = new Video("Hackschooling makes me happy", "Blah", "http://img.youtube.com/vi/h11u3vtcpaY/0.jpg");
            v.save();
            v = new Video("My philosophy for a happy life", "Blah", "http://img.youtube.com/vi/36m1o-tM05g/0.jpg");
            v.save();
            v = new Video("Why I stopped watching porn", "Blah", "http://img.youtube.com/vi/gRJ_QfP2mhU/0.jpg");
            v.save();
            v = new Video("Coming out of your closet", "Blah", "http://img.youtube.com/vi/kSR4xuU07sc/0.jpg");
            v.save();
        }
    ...
    public static Result view(long id) {
        ...
        VideoClip clip = new VideoClip("/assets/test1.mp4", null, 100);
        v.addClip(clip);
        clip = new VideoClip("/assets/test2.mp4", null, 100);
        v.addClip(clip);
        clip = new VideoClip("/assets/test3.mp4", null, 100);
        v.addClip(clip);
        clip = new VideoClip("/assets/test4.mp4", null, 100);
        v.addClip(clip);
        clip = new VideoClip("/assets/test5.mp4", null, 100);
        v.addClip(clip);
